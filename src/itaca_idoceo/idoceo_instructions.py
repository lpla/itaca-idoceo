...
def build_import_instructions(*, has_photos: bool, normalize_names: bool) -> str:
    lines = [
        ...
        "con el mismo nombre: no lo vuelve a crear, actualiza sus datos personales y añade los alumnos nuevos.",
        "El XLSX generado por esta herramienta no contiene columnas de evaluación, por lo",
        "que no necesita sustituir las notas que ya tengas en iDoceo.",
        "",
